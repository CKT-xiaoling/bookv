...
<head>
    ...
    <title>Bookv</title>
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/home-style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/home-medias.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(URL::asset('js/player/mediaelementplayer.css')); ?>">
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,400italic,300italic,300,700,700italic|Open+Sans+Condensed:300,700' rel="stylesheet" type='text/css'>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery-1.12.3.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/ddsmoothmenu.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/retina.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/selectnav.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.masonry.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.fitvids.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.backstretch.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/mediaelement.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/mediaelementplayer.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.dcflickr.1.0.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(URL::asset('js/twitter.min.js')); ?>"></script>
...
<div class="header-wrapper opacity">
    <div class="header">
        ...
        <div class="logo">
            <a href="index.html">
                <img src=<?php echo e(URL::asset('images/logo.png')); ?> alt="" />
            </a>
        </div>
        <!-- End Logo -->
        <!-- Begin Menu -->
    ...
    <div class="blog-wrap">
        ...
        <div class="blog-grid">
            ...
            <div class="post format-image box">
                <div class="frame">
                    <a href="post.html">
                        <img src="<?php echo e(URL::asset('images/art/post1.jpg')); ?>" alt="" />
                    </a>
                </div>
            ...
            <div class="post format-video box">
                <div class="video frame"><iframe src="http://sc.chinaz.com" width="500" height="281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
            ...
            <div class="post format-audio box">
                <div class="audio-wrapper">
                    <div class="vinyl">
                        <dl>
                            <dt class="art">
                                <img class="highlight" src="<?php echo e(URL::asset('images/vinyl.png')); ?>" />
                                <img src="<?php echo e(URL::asset('images/art/artwork.png')); ?>" alt="" />
                            </dt>
                ...
                <p><strong>DetektivbyrÃ¥n</strong> (&#8220;The Detective Agency&#8221;) was a Swedish electronica and folk music trio from Gothenburg. The group consisted of Anders &#8220;Flanders&#8221; Molin (accordion</a>, music box</a>), Martin &#8220;MacGyver&#8221; Molin (glockenspiel</a>, traktofon, toy piano</a>, Theremin</a>) and Jon Nils Emanuel EkstrÃ¶m drums</a>, sound box</a>, small bells</a>.</p>
            ...
            <div class="post format-link box">
                ...
                <h2 class="title">The Italic Mountains<span class="arrow">&rarr;</span></h2>
        ...
        <div id="second" class="widget-area">
            <div id="twitter-2" class="widget widget_twitter">
                ...
                <div id="twitter-wrapper">
                    <div id="twitter"></div>
                    <span class="username">â†?Follow @elemisdesign</span>
                </div>
            </div>
        ...
        <div id="third" class="widget-area">
            <div id="example-widget-3" class="widget example">
                ...
                <ul class="post-list">
                    <li>
                        <div class="frame">
                            <a href="#"><img src="<?php echo e(URL::asset('images/art/s1.jpg')); ?>" /></a>
                        </div>
                        <div class="meta">
                    ...
                    <li>
                        <div class="frame">
                            <a href="#"><img src="<?php echo e(URL::asset('images/art/s2.jpg')); ?>" /></a>
                        </div>
                        <div class="meta">
                    ...
                    <li>
                        <div class="frame">
                            <a href="#"><img src="<?php echo e(URL::asset('images/art/s3.jpg')); ?>" /></a>
                        </div>
                        <div class="meta">
...
<div class="site-generator-wrapper">
    <div class="site-generator">&copy; Copyright &copy; 2013.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></div>
</div>
<!-- End Footer -->
