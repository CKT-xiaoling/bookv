...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/home-medias.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('js/player/mediaelementplayer.css') }}">
    ...
    <script type="text/javascript" src="{{ URL::asset('js/selectnav.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ URL::asset('js/mediaelement.min.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/mediaelementplayer.min.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/jquery.dcflickr.1.0.js') }}"></script>
    <script type="text/javascript" src="{{ URL::asset('js/twitter.min.js') }}"></script>
    ...
    <div class="blog-wrap">
        ...
        <div class="blog-grid">
            ...
            <div class="post format-image box">
                <div class="frame">
                    <a href="post.html">
                        <img src="{{ URL::asset('images/art/post1.jpg')}}" alt="" />
                    </a>
                </div>
            ...
            <div class="post format-audio box">
                <div class="audio-wrapper">
                    <div class="vinyl">
                        <dl>
                            <dt class="art">
                                <img class="highlight" src="{{ URL::asset('images/vinyl.png')}}" />
                                <img src="{{ URL::asset('images/art/artwork.png')}}" alt="" />
                            </dt>
        ...
        <div id="third" class="widget-area">
            <div id="example-widget-3" class="widget example">
                ...
                <ul class="post-list">
                    <li>
                        <div class="frame">
                            <a href="#"><img src="{{ URL::asset('images/art/s1.jpg')}}" /></a>
                        </div>
                        <div class="meta">
                    ...
                    <li>
                        <div class="frame">
                            <a href="#"><img src="{{ URL::asset('images/art/s2.jpg')}}" /></a>
                        </div>
                        <div class="meta">
                    ...
                    <li>
                        <div class="frame">
                            <a href="#"><img src="{{ URL::asset('images/art/s3.jpg')}}" /></a>
                        </div>
                        <div class="meta">
